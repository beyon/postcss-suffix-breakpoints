...
exports.default = postcss.plugin('postcss-reverse-props', function () {
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    // opts = opts || {};
    // Work with options here
    var breakpoints = [{ suffix: '-ns', var: '--breakpoint-not-small' }, { suffix: '-m', var: '--breakpoint-medium' }, { suffix: '-l', var: '--breakpoint-large' }];
    ...
    return function (root, result) {
        ...
        for (var bp = 0; bp < breakpoints.length; bp++) {
            ...
            for (var idx = 0; idx < classRules.length; idx++) {
                ...
                mediaClassRules.set(nameWithSuffix, classRules[idx].clone({ selector: nameWithSuffix }));
            }
